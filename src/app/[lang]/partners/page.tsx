...
const bodegas = [
    {
        ...
        videoUrl: "/partners/Trivento.mp4"
    },
    {
            ...
            <div>
                {
                    bodegas.map((bodega, i) => (
                        <Link key={bodega.title} href={'#'} target="_blank" className={`${i === bodegas.length - 1 ? "border-none" : "border-b-4 border-black"} flex flex-col lg:flex-row-reverse gap-6 pt-10 pb-10`}>
                            ...
                            <div className="w-full min-h-full bg-gray-200 block">
                                <video controls width="100%" height="auto" autoPlay loop muted playsInline>
                                    <source src={bodega.videoUrl} type="video/mp4" />
