        ...
        <div className="bg-background text-foreground dark px-3 lg:px-20 pt-16 pb-20 min-h-screen">
            <ScrollTrigger onEnter={() => setIsEnter(true)} onExit={() => setIsEnter(false)}>
                <div className="flex flex-col lg:flex-row items-center gap-5 lg:gap-10">
                    <div className="relative w-full flex flex-col justify-around lg:justify-between items-center lg:items-start h-screen">
                        <div className="relative">
                            <h2 className="text-[250px] font-medium">
                                {isEnter && <CountUp start={0} end={40} duration={15} />}
                            </h2>
                    ...
                    <div className="w-full flex flex-col justify-between min-h-full gap-10 lg:gap-28">
                        ...
                        <div className='flex flex-col items-center lg:items-start gap-5'>
                            <div className="flex flex-col lg:flex-row items-center gap-5 justify-start w-fit max-w-lg">
                                <p className="text-7xl text-white ">
                                    {isEnter && <CountUp start={0} end={60} duration={10} />}
                                </p>
                            ...
                            <div className="flex flex-col lg:flex-row items-center gap-5 justify-start w-fit max-w-lg">
                                <p className="text-5xl text-white ">
                                    {isEnter && (
                                        <span>
                                            <CountUp start={0} end={16} duration={10} /> a <CountUp start={0} end={25} duration={10} />
                                        </span>
                                    )}
                                </p>
