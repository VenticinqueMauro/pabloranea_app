        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-10">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="underline font-bold text-black">Insiders Agencia</a> & <a href="https://mvdev.vercel.app/" className="underline font-bold text-black">MVDEV</a>. All Rights Reserved.</span>
