...
export default function GiraEnNum() {
    return (
        <div className="bg-black pt-10 pb-28 relative">
            <div className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl px-6 sm:px-10 md:px-16 lg:px-20 xl:px-40 mx-auto text-white font-bold text-justify leading-tight ">
